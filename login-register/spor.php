...
<head>
    ...
    <link rel="stylesheet" href="css/spor.css">
        ...
        <div class="row">
            <div class="col-md-3">                				
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(spor_brand) FROM spor WHERE spor_status = '1' ORDER BY spor_id DESC";
                    ...
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector brand" value="<?php echo $row['spor_brand']; ?>"  > <?php echo $row['spor_brand']; ?></label>
                    </div>
                    <?php
                    }
				...
				<div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(spor_size) FROM spor WHERE spor_status = '1' ORDER BY spor_size DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    ...
                    ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector size" value="<?php echo $row['spor_size']; ?>" > <?php echo $row['spor_size']; ?></label>
                    </div>
                    <?php    
                    }
				...
				<div class="list-group">
					...
					<?php
                    $query = "
                    SELECT DISTINCT(spor_color) FROM spor WHERE spor_status = '1' ORDER BY spor_color DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    ...
                    ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector color" value="<?php echo $row['spor_color']; ?>"  > <?php echo $row['spor_color']; ?></label>
                    </div>
                    <?php
                    }
                    ?>	
