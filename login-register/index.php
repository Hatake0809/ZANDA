...
<body>
    ...
    <div class="kategori_1" style="animation: slide 1.5s ease forwards;  animation-delay: calc(.2s * var(--i));">
        <div>
            <div class="options">
                <div class="option active" style="--optionBackground: url(image/Kısayol/1.png); ">
                    <a href="elektronik.php">
                        <div class="label1">
                            ...
                            <div class="info">
                                <div class="main">Elektronik</div>
                                <div class="sub">Dizüstü Bilgisayarlar</div>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="option" style="--optionBackground: url(image/Kısayol/2.png);">
                    <a href="elektronik.php">
                        <div class="label1">
                            <div class="icon">
                            ...
                            <div class="info">
                                <div class="main">Elektronik</div>
                                <div class="sub">TWS Kulaklıklar</div>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="option" style="--optionBackground: url(image/Kısayol/3.png);">
                    <a href="moda.php">
                        <div class="label1">
                            <div class="icon">
                            ...
                            <div class="info">
                                <div class="main">Giyim</div>
                                <div class="sub">Kazak Ve Hırkalar</div>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="option" style="--optionBackground: url(image/Kısayol/4.png);">
                    <a href="spor.php">
                        <div class="label1">
                            <div class="icon">
                            ...
                            <div class="info">
                                <div class="main">Spor & Outdoor</div>
                                <div class="sub">Spor Aletleri</div>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="option" style="--optionBackground: url(image/Kısayol/5.png);">
                    <a href="spor.php">
                        <div class="label1">
                            <div class="icon">
