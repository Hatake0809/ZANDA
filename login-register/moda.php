    ...
    <div class="head">
        ...
        <nav class="navbar">
            ...
            <span class="kategori">
                ...
                <ul class="alt-menu">
                    <li><a  href="moda.php">Elektronik</a></li>
        ...
        <div class="row">
            <div class="col-md-3">                				
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(moda_brand) FROM moda WHERE moda_status = '1' ORDER BY moda_id DESC";
                    ...
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector brand" value="<?php echo $row['moda_brand']; ?>"  > <?php echo $row['moda_brand']; ?></label>
                    </div>
                    <?php
                    }
				...
				<div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(moda_size) FROM moda WHERE moda_status = '1' ORDER BY moda_size DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    ...
                    ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector size" value="<?php echo $row['moda_size']; ?>" > <?php echo $row['moda_size']; ?></label>
                    </div>
                    <?php    
                    }
				...
				<div class="list-group">
					...
					<?php
                    $query = "
                    SELECT DISTINCT(moda_gender) FROM moda WHERE moda_status = '1' ORDER BY moda_gender DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    ...
                    ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector gender" value="<?php echo $row['moda_gender']; ?>"  > <?php echo $row['moda_gender']; ?></label>
                    </div>
                    <?php
                    }
                    ?>	
...
$(document).ready(function(){
    ...
    function filter_data()
    {
        ...
        $.ajax({
            url:"filitreleme_moda.php",
            method:"POST",
            data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price, brand:brand, size:size, gender:gender},
