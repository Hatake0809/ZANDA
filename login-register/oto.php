...
<head>
    ...
    <link rel="stylesheet" href="css/oto.css">
...
<body>
    ...
    <div class="container" style="height:700px ; margin-left:15% ; animation: slide 2s ease forwards;  animation-delay: calc(.2s * var(--i)); ">
            <h2 class="text-uppercase" style="color:white ; font-size:40px; margin-left:30%">
        ...
        <div class="row">
            <div class="col-md-3">                				
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(oto_brand) FROM oto WHERE oto_status = '1' ORDER BY oto_id DESC";
                    ...
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector brand" value="<?php echo $row['oto_brand']; ?>"  > <?php echo $row['oto_brand']; ?></label>
                    </div>
                    <?php
                    }
				...
				<div class="list-group">
					...
					<?php
                    $query = "
                    SELECT DISTINCT(oto_color) FROM oto WHERE oto_status = '1' ORDER BY oto_color DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    ...
                    ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector color" value="<?php echo $row['oto_color']; ?>"  > <?php echo $row['oto_color']; ?></label>
                    </div>
                    <?php
                    }
                    ?>	
